...
const Fotter = () => {
  return (
  <>
            <footer className=' font-playfair bg-[#0a1128] py-12 px-4 sm:px-6 lg:px-8'>
                <div className='w-full max-w-7xl mx-auto'>
            
                    <div className="flex flex-wrap justify-between gap-y-12 lg:gap-x-8">
                        <div className="w-full md:w-[45%] lg:w-[35%] flex flex-col items-center md:items-start text-center md:text-left">
                            <span className="font-black text-3xl md:text-5xl tracking-tight text-white">
                            ...
                            <p className='text-sm text-white/60 mt-6 max-w-sm leading-relaxed'>
                                Your trusted destination for discovering exceptional stays, seamless bookings, and unforgettable travel experiences. 
                                Every journey begins with StayNxt.
                            </p>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <p className='text-xs text-white/60'>© {new Date().getFullYear()} StayNxt</p>
